...
|----------|----------|--------|--------|---------|---------------|
| P0 | Does the observation space contain any predictive signal? | Not started | — | — | If supervised classifier > 55% accuracy: signal exists, RL is failing to exploit. If ~50%: features lack predictive power. Determines whether to invest in better RL or better features. |
