...
#
# Unified hook for TDD (claude-tdd-kit) and Research (claude-research-kit).
# Dispatches on mutually exclusive env vars:
#   TDD_PHASE  -- set by tdd.sh (green)
#   EXP_PHASE  -- set by experiment.sh (run, read, synthesize)
#
...
# ══════════════════════════════════════════════════════════════
# TDD Enforcement (green phase)
# ══════════════════════════════════════════════════════════════

if [[ "${TDD_PHASE:-}" == "green" ]]; then

  # Patterns that identify test files (C++ and Python)
  TEST_PATTERNS='(test_[^/]*\.|[^/]*_test\.|[^/]*\.test\.|[^/]*\.spec\.|/tests/|/test/|/__tests__/|/spec/|/python/tests/)'
...
# ══════════════════════════════════════════════════════════════
# Research Enforcement (run, read, synthesize phases)
# ══════════════════════════════════════════════════════════════
